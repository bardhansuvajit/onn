...
<section>
    <form method="post" action="{{ route('admin.product.store') }}" enctype="multipart/form-data">@csrf
        ...
        <div class="col-sm-9">
            ...
            <div class="form-group mb-3">
                <textarea id="product_des" name="desc"></textarea>
            ...
            <div class="card-body">
                <textarea id="product_short_des" name="short_desc"></textarea>
            ...
            <div class="card-body pt-0">
                ...
                <content>
                    ...
                    <div class="col-auto">
                        <input type="text" id="inputprice6" class="form-control" aria-describedby="priceHelpInline" name="price">
                    ...
                    <div class="col-auto">
                        <input type="text" id="inputprice6" class="form-control" aria-describedby="priceHelpInline" name="offer_price">
                ...
                <div class="admin__content">
                    ...
                    <content>
                        <div class="row mb-2 align-items-center">
                            ...
                            <div class="col-auto">
                                <input type="text" id="inputprice6" class="form-control" aria-describedby="priceHelpInline" name="meta_title">
                        ...
                        <div class="row mb-2 align-items-center">
                            ...
                            <div class="col-auto">
                                <input type="text" id="inputprice6" class="form-control" aria-describedby="priceHelpInline" name="meta_desc">
                        ...
                        <div class="row mb-2 align-items-center">
                            ...
                            <div class="col-auto">
                                <input type="text" id="inputprice6" class="form-control" aria-describedby="priceHelpInline" name="meta_keyword">
                ...
                <div class="admin__content">
                    ...
                    <content>
                        ...
                        <div class="col-auto">
                            <input type="text" id="inputprice6" class="form-control" aria-describedby="priceHelpInline" name="style_no">
