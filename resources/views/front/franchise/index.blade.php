...
})(window,document,'script','dataLayer','GTM-PQBVBX9');</script>
...
<section class="contact_form" id="partnerForm">
	...
	<div class="container text-center mt-5">
		...
		<div class="row justify-content-center mt-5">
			<div class="col-sm-4">
				<a href="tel:+91-90070 21060" class="account-card">
                    <figure>
                        <span>
            ...
            <div class="col-sm-4">
				<a href="mailto:onn.ebo@luxinnerwear.com" class="account-card">
                    <figure>
                        <span>
                    ...
                    <figcaption>
                        <h4>onn.ebo@luxinnerwear.com</h4>
                    </figcaption>
                </a>
            </div>
		</div>
