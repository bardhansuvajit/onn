            ...
            <div class="col-sm-7 col-lg-7">
                <div class="row">
                    <div class="col-sm-12 col-lg-6">
                        <a href="https://onninternational.com/corporate" class="account-card">
                            <figure>
                                <span>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <a href="https://onninternational.com/news" class="account-card">
                            <figure>
                                <span>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <a href="https://onninternational.com/career" class="account-card">
                            <figure>
                                <span>
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <a href="https://onninternational.com/global" class="account-card">
                            <figure>
                                <span>
