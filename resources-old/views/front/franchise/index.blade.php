...
<style type="text/css">
	.franchise_banner {
		...
		background: url('{{asset('/img/onn_franchise11.jpg')}}') center right no-repeat;
		position: relative;
	}
...
<section class="franchise_gallery">
	<div class="container-fluid">
		...
		<div class="row justify-content-center">
			...
			<div class="col-12 d-none d-sm-flex"></div>
			<div class="col-6 col-sm">
				<figure>
					<img src="{{asset('/img/onn_franchise06.jpg')}}">
				</figure>
			</div>
			<div class="col-6 col-sm">
				<figure>
					<img src="{{asset('/img/onn_franchise07.jpg')}}">
				</figure>
			</div>
			<div class="col-6 col-sm">
				<figure>
					<img src="{{asset('/img/onn_franchise08.jpg')}}">
				</figure>
			</div>
			<div class="col-6 col-sm">
				<figure>
					<img src="{{asset('/img/onn_franchise09.jpg')}}">
				</figure>
			</div>
			<div class="col-6 col-sm">
				<figure>
					<img src="{{asset('/img/onn_franchise10.jpg')}}">
				</figure>
			</div>
		</div>
	</div>
...
<section class="contact_form" id="partnerForm">
	...
	<div class="container text-center mt-5">
		<h4>For further details, contact<br/><a href="tel:+91-90070 21060">+91-90070 21060</a><br/><a href="mailto:+91-90070 21060">sagar.shah@luxinnerwear.com</a></h4>
	</div>
</section>
