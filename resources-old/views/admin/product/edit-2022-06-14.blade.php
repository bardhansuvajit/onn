            ...
            <div class="admin__content">
                ...
                <content>
                    <div class="color_holder row_position">
                        ...
                        <div class="color_holder_single" id="{{$productWiseColorsVal->id}}">
                            <div class="color_box shadow-sm">
                                ...
                                <p class="small card-title">{{ $productWiseColorsVal->colorDetails->name }}</p>
                            </div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="color_box">
                                ...
                                <p>{{ $productColorGroupVal->colorDetails->name }}</p>
                            </div>
                        </div>
                        <div class="col-sm">
                            <div class="row">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    @php
                                        ...
                                        foreach($productVariationColorSizes as $productSizeKey => $productSizeVal) {
                                            $prodSizesDIsplay .= '<div class="size_holder"><div class="row align-items-center"><div class="col-sm">'.$productSizeVal->sizeDetails->name.'</div><div class="col-sm-3">Price Rs '.$productSizeVal->price.'</div><div class="col-sm-3">Offer Rs '.$productSizeVal->offer_price.'</div><div class="col-sm-auto"><a href='.route('admin.product.variation.size.delete', $productSizeVal->id).' class="btn btn-sm btn-outline-danger">Delete size</a></div></div></div>';
                                        }
                                        $prodSizesDIsplay .= '';
                                    @endphp
                                    {!!$prodSizesDIsplay!!}
