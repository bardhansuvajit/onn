        ...
        <div class="card-body pt-0">
            <div class="admin__content">
                ...
                <content>
                    ...
                    @php
                        // $test = \DB::select('SELECT count(pc.id), c.id, c.name, pc.position FROM product_color_sizes AS pc JOIN colors AS c ON pc.color = c.id WHERE pc.product_id = "13" GROUP BY pc.color ORDER BY pc.position');
                    ...
                    <div class="color_holder row_position">
                        ...
                        <div class="color_holder_single single-color-holder" id="{{$productWiseColorsVal->id}}">
                            <div class="color_box shadow-sm" style="{!! ($productWiseColorsVal->status == 0) ? 'background: #c1080a59;' : '' !!}" data-toggle="tooltip" title="STats">
                        ...
                        {{-- @foreach ($productColorGroup as $productWiseColorsKey => $productWiseColorsVal)
                        @if($productWiseColorsVal->status == 0)
                        <div class="color_holder_single single-color-holder" id="{{$productWiseColorsVal->id}}">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('admin.product.variation.color.add')}}" method="post">@csrf
                <input type="hidden" name="product_id" value="{{$id}}">
                <div class="form-group mb-3">
                    <select class="form-control" name="newcolor" id="">
                ...
                <div class="form-group mb-3">
                    <select class="form-control" name="newsize" id="">
                ...
                <div class="form-group mb-3">
                    <input class="form-control" type="text" name="newprice" id="" placeholder="Price">
                </div>
                <div class="form-group mb-3">
                    <input class="form-control" type="text" name="newoffer_price" id="" placeholder="Offer Price">
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-sm btn-success">+ Add color & size</button>
                </div>
            </form>
        </div>
      </div>
