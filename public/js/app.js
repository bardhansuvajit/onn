...
$(".overlay .overlay__close").click(function () {
  ...
  $(".overlay").css({"transform": "translateY(-150%)", "opacity": "0"});
...
function toggle_overlay() {
  ...
  $(".overlay").css({"transform": "translateY(0%)", "opacity": "1"});
...
producttextmove
.from($producttext, 1, {yPercent: -100, ease: Power4.linear})
...
producttitlemove
.from($producttitle, 1, {yPercent: -400, opacity: 0, ease: Power4.linear})
...
.to($collectionbefore, 1, {width: "28%", ease: Power4.linear})
...
collectiontextmove
.from($collectiontext, 1, {yPercent: 200, ease: Power4.linear})
...
categorytextmove
.from($categorytext, 1, {yPercent: -150, ease: Power4.linear})
